...
<h1 class="text-center">RESEARCHES 2015-2021&nbsp;</h1>
       ...
       <form action="soed.php" method="POST">
           <select class="form-control" name="searching" required="">
            <option></option>
            <?php 
            $sel_yr = mysqli_query($connection,"SELECT  DISTINCT yr FROM research WHERE research_category= 2 AND dept='SOED' ") or die(mysqli_error($connection));
 ...
 <form action="../../nextpage.php" method="POST">
   <div class="row">
    ...
    if(isset($_POST['search'])){
      ...
      $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SOED' AND research_category = 2 AND yr='$searching'")or die(mysqli_error($connection));
    }else{
      $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SOED' AND research_category = 2 ORDER BY yr DESC")or die(mysqli_error($connection));
    }
