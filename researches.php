...
<h1 class="text-center">Research, Extension &amp; Training of WVS-PC&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</h1>
<div class="text-break">&nbsp;</div>
<div class="row">
      <div class="col-xl-4">
            <div class="card col-md-4 col-xl-12"> <img class="card-img-top" src="images/row1.jpg" alt="Card image cap">
              <div class="card-body">
                ...
                <p class="card-text">In this section you can see different researches by every student of every school department.&nbsp; &nbsp;</p>
          ...
          <div class="col-xl-4">
            <div class="card col-md-4 col-xl-12"> <img class="card-img-top" src="images/row3.jpg" alt="Card image cap">
              <div class="card-body">
                ...
                <p class="card-text">In this section you can see the researches of the faculty ongoing and published ones.&nbsp; &nbsp; &nbsp;</p>
