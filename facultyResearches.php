  ...
  <body>
  	<div class="container-fluid">
        ...
        ?>
  	   ...
  	   <BR>
  	    <h1 class="text-center">FACULTY RESEARCHES 2015-2021&nbsp;</h1>
     <BR>
		 <BR>
        <div class="row">
          <div class="col-xl-4">
            <div class="card col-md-4 col-xl-12"> <img class="card-img-top" src="images/soedlogo.jpg" alt="Card image cap">
              <div class="card-body">
                ...
                <a href="FacultyResearches/SOED/soed.php" class="btn btn-primary">READ MORE&nbsp;</a> </div>
            </div>
          </div>
          <div class="col-xl-4">
            <div class="card col-md-4 col-xl-12"> <img class="card-img-top" src="images/sbmlogo.jpg" alt="Card image cap">
              <div class="card-body">
                ...
                <p class="card-text">Brief information about the program.</p>
                <a href="FacultyResearches/SBM/sbm.php" class="btn btn-primary">READ MORE&nbsp;</a> </div>
            </div>
          </div>
          <div class="col-xl-4">
            <div class="card col-md-4 col-xl-12"> <img class="card-img-top" src="images/soitlogo.png" alt="Card image cap">
              <div class="card-body">
                ...
                <p class="card-text">Brief information about the program.</p>
                <a href="FacultyResearches/SOIT/soit.php" class="btn btn-primary">READ MORE&nbsp;</a> </div>
            </div>
          </div>
        </div>
<br>
  ...
  <div class="col-xl-4">
    <div class="card col-md-4 col-xl-12"> <img class="card-img-top" src="images/ictlogo.jpg" alt="Card image cap">
      <div class="card-body">
        ...
        <p class="card-text">Brief information about the program.</p>
        <a href="FacultyResearches/SICT/sict.php" class="btn btn-primary">READ MORE&nbsp;</a></div>
    </div>
  </div>
  <div class="col-xl-4"> </div>
</div>
