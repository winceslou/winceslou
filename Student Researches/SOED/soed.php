   ...
   <div class="container">
    ...
    <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
     ...
     <div class="">
       ...
       <form action="soed.php" method="POST">
           <select class="form-control" name="searching" required="">
            <option></option>
            <?php 
            $sel_yr = mysqli_query($connection,"SELECT  DISTINCT yr FROM research WHERE research_category=1 AND dept='SOED' ORDER BY yr DESC ") or die(mysqli_error($connection));
        ...
        <div class="col-1 px-1" style="margin-left: 65%"><a href="soed.php"><button class="btn-primary py-1 rounded px-3">Refresh</button></a></div>
     </div>
 </div><br><br>
 <form action="../../nextpage.php" method="POST">
   <div class="row">
    ...
    if(isset($_POST['search'])){
      ...
      $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SOED' AND research_category = 1 AND yr='$searching'")or die(mysqli_error($connection));
    }else{
      $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SOED' AND research_category = 1 ORDER BY yr DESC")or die(mysqli_error($connection));
    }
    while($res = mysqli_fetch_array($sel_sbm)){ 
      ...
      <div class="col-4 px- py-1 mb-2">
        <div class="bg-light shadow px-2" style="height: 200px; ">
          ...
          <p class="card-text">This page contains researches oF SOED year <?php echo $res['yr'] ?>.</p>
