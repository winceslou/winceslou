 ...
 <form action="../../nextpage.php" method="POST">
   <div class="row">
    ...
    if(isset($_POST['search'])){
      ...
      $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SOICT' AND research_category = 1 AND yr='$searching'")or die(mysqli_error($connection));
    }else{
      $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SOICT' AND research_category = 1 ORDER BY yr DESC")or die(mysqli_error($connection));
    }
      while($res = mysqli_fetch_array($sel_sbm)){ 
        ?>
          ...
          <div class="col-4 px- py-1 mb-2">
            ...
            <p class="card-text">This page contains researches oF SOICT year <?php echo $res['yr'] ?>.</p>
