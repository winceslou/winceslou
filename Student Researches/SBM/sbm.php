     ...
     <div class="row">
      ...
      if(isset($_POST['search'])){
        $searching = $_POST['searching'];
          $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SBM' AND research_category = 1 AND yr='$searching'")or die(mysqli_error($connection));
      }else{
          $sel_sbm = mysqli_query($connection,"SELECT DISTINCT yr,dept,research_category FROM research WHERE dept='SBM' AND research_category = 1 ORDER BY yr DESC")or die(mysqli_error($connection));
      }
