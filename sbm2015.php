  ...
  <body>
  	<div class="container-fluid">
        ...
        ?>
		 ...
		 <br>
  	    <h3 class="text-center">SCHOOL OF BUSINESS &amp; MANAGEMENT (SBM)&nbsp; A.Y. 2015&nbsp;</h3>
...
<div class="card-body">
          ...
          <div class="col-xl-4">
            <div class="card col-md-4 col-xl-12">
<div class="card-body">
            <h5 class="card-title">gwapo c sienes &nbsp;&nbsp;</h5>
                <p class="card-text">Brief information like year published.</p>
    ...
    <div class="card col-md-4 col-xl-12">
      <div class="card-body">
        ...
        <a href="studentResearches.php" class="btn btn-primary">READ MORE&nbsp;</a></div>
		  ...
		  <br>
		   <center>
			<div class="btn" ><a href="sbm.php">PREV&nbsp;</a></div> 
  ...
  <div class="card">
        <div class="card-header" role="tab" id="headingOne1">
            ...
            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordion1">
              <div class="card-body">In this section you can see the announcements posted&nbsp; &nbsp; for everyone.&nbsp; &nbsp;&nbsp;</div>
            </div>
      </div>
      <div class="card">
